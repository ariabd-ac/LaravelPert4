                            ...
                            <div class="card-body">
                                ...
                                <form>
                                    ...
                                    <div class="form-row">
                                        ...
                                        <input type="text" class="form-control" id="validationDefault01" value="{{ $teacher->nama}}">
                                        ...
                                        <div class="col-md-4 mb-3">
                                          ...
                                          <input type="text" class="form-control" id="validationDefault02" placeholder="123456  " value="{{ $teacher->nig}}">
                                        ...
                                        <div class="col-md-4 mb-3">
                                         ...
                                         <input type="text" class="form-control" id="validationDefault02" placeholder="24 Juni 1972" value="{{ $teacher->ttl}}">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-3 mb-3">
                                          ...
                                          <input type="text" class="form-control" id="validationDefault03" placeholder="0832783438" value="{{ $teacher->no_tlp}}">
                                        ...
                                        <div class="col-md-3 mb-3">
                                          ...
                                          <input type="text" class="form-control" id="validationDefault03" placeholder="Humas" value="{{ $teacher->jabatan}}">
                                        ...
                                        <div class="col-md-3 mb-3">
                                          ...
                                          <input type="text" class="form-control" id="validationDefault04" placeholder="Agama" value="{{ $teacher->mp}}">
                                        ...
                                        <div class="col-md-3 mb-3">
                                          ...
                                          <input type="text" class="form-control" id="validationDefault05" placeholder="Honorer" value="{{ $teacher->status}}">
